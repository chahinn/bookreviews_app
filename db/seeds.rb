...
b11 = Book.create(title: "Nicolas", author: "chahin", description: "A law professor takes aim at the war on drugs and its impact on black men.", publisher: "New Press", weeks_on_list: 88, rank_this_week: 10)
b12 = Book.create(title: "Camila", author: "Chahin", description: "A law professor takes aim at the war on drugs and its impact on black men.", publisher: "New Press", weeks_on_list: 88, rank_this_week: 10)
...
Review.create(comment: "good.", author: "Daily Kos", book_id: b11.id)
Review.create(comment: "excellent", author: "Daily Kos", book_id: b12.id)